...
# Directory paths
INPUT_DIR="/home/root/pedestrian_area/raw"
OUTPUT_BASE="/home/root/max_channels_achieved"

# Configuration arrays
declare -a encoders=("x264")
declare -a presets=("ultrafast")
...
for codec in "${encoders[@]}"; do
    for video in "${videos[@]}"; do
		...
		current_dir="$OUTPUT_BASE/$codec/$video_name/$preset/$ch"_ch""
