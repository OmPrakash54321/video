def sort_performance_data_from_file(file_path):
    ...
    for line in lines:
        ...
        if len(parts) >= 2:
            ...
            # Append the entry as a tuple (name, last column value)
            entries.append((entry_name, last_column_value_float))
    ...
    for name, value in sorted_entries:
        sorted_output.append(f"{name} | {value}")
...
# Call the function and print sorted results
sorted_results = sort_performance_data_from_file(file_path)
